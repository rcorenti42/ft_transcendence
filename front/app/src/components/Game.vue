...
<template>
    ...
    <v-dialog v-model="endGame" persistent transition="dialog-top-transition" max-width="600">
      <template>
      <v-card dark>
        <v-toolbar color="primary" dark>test</v-toolbar>
        <v-card-text>
          <div class="text-h2 pa-12"> has won! </div>
        </v-card-text>
      </v-card>
    </template>
    </v-dialog>
